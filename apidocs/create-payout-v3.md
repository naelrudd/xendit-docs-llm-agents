        ...
        "responses": {
          ...
          "400": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/CreatePayout400Body"
                }
              }
            }
          },
          ...
          "403": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/CreatePayout403Body"
                }
              }
            }
          },
          "404": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/Http404DataNotFound_QuoteId"
                }
              }
            }
          },
          "409": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/Http409DuplicateError"
                }
              }
            }
          },
  ...
  "components": {
    "schemas": {
      ...
      "CreatePayout400Body": {
        "oneOf": [
          {
            "$ref": "#/components/schemas/Http400ApiValidationError"
          },
          {
            "$ref": "#/components/schemas/Http400ApiValidationError_BothAmounts"
          },
          {
            "$ref": "#/components/schemas/Http400InvalidValueError_UnsupportedSourceCurrency"
          },
          {
            "$ref": "#/components/schemas/Http400InvalidValueError_UnsupportedDestinationCurrency"
          },
          {
            "$ref": "#/components/schemas/Http400InvalidValueError_AmountTooLow"
          },
          {
            "$ref": "#/components/schemas/Http400InvalidValueError_AmountTooHigh"
          },
          {
            "$ref": "#/components/schemas/Http400InvalidQuote"
          }
        ]
      },
      ...
      "CreatePayout403Body": {
        "oneOf": [
          ...
          {
            "$ref": "#/components/schemas/Http403RequestForbiddenError_Account"
          },
          {
            "$ref": "#/components/schemas/Http403InvalidMerchantSettings_Payout"
          }
        ]
      },
      "Http404DataNotFound_QuoteId": {
        "type": "object",
        "required": [
          "error_code",
          "message"
      ...
      "Http400ApiValidationError_BothAmounts": {
        "type": "object",
        "required": [
          "error_code",
          "message"
      ...
      "Http400InvalidValueError_UnsupportedSourceCurrency": {
        "type": "object",
        "required": [
          "error_code",
          "message"
      ...
      "Http400InvalidValueError_UnsupportedDestinationCurrency": {
        "type": "object",
        "required": [
          "error_code",
          "message"
      ...
      "Http400InvalidValueError_AmountTooLow": {
        "type": "object",
        "required": [
          "error_code",
          "message"
      ...
      "Http400InvalidValueError_AmountTooHigh": {
        "type": "object",
        "required": [
          "error_code",
          "message"
      ...
      "Http403RequestForbiddenError_Account": {
        "type": "object",
        "required": [
          "error_code",
          "message"
      ...
      "Http403InvalidMerchantSettings_Payout": {
        "type": "object",
        "required": [
          "error_code",
          "message"

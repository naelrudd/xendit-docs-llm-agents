...
````json GET /recurring/plans/{plan_id}/cycles/{id}
{
  "openapi": "3.0.0",
  "info": {
    "title": "Payments",
  ...
  "paths": {
    "/recurring/plans/{plan_id}/cycles/{id}": {
      "get": {
        ...
        "summary": "Get Subscription Cycle",
        "description": "Retrieves details of a specific subscription cycle by its ID.",
        "operationId": "getRecurringCycle",
        "parameters": [
          {
            "name": "api-version",
            "in": "header",
        ...
        "responses": {
          "200": {
            "description": "Successfully retrieved the recurring cycle.",
            "content": {
              "application/json": {
                "schema": {
        ...
        "callbacks": {
          "recurringCycle": {
            "/{merchant defined callback url}": {
              "post": {
                "summary": "Recurring Cycle Webhook",
                "description": "Webhooks sent for recurring cycle status updates:\n- `recurring.cycle.created`: Sent when a new recurring cycle is created for a plan.\n- `recurring.cycle.retrying`: Sent when a cycle payment fails and a retry is scheduled based on the retry configuration.\n- `recurring.cycle.succeeded`: Sent when a cycle payment is successfully completed.\n- `recurring.cycle.failed`: Sent when a cycle payment fails after all retry attempts are exhausted.\n- `recurring.cycle.force_attempt_failed`: Sent when a forced payment attempt on a cycle fails.\n",
                "requestBody": {
                  "description": "Recurring cycle webhook payload",
                  "content": {
                    "application/json": {
                      "schema": {

...
````json GET /v3/payment_tokens/{payment_token_id}
{
  "openapi": "3.0.0",
  "info": {
    "title": "Payments",
  ...
  "paths": {
    "/v3/payment_tokens/{payment_token_id}": {
      "get": {
        "security": [
          {
        ...
        "summary": "Get the status of a payment token",
        "description": "Retrieve the status of your payment token.\n",
        "tags": [
          "Payment Token"
        ],
        "parameters": [
        ...
        "responses": {
          "200": {
            "description": "Fetch Payment Token Status",
            "content": {
              "application/json": {
                "schema": {

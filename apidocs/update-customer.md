...
canonical: "docs.xendit.co/update-customer"
---
...
Path parameterscustomer_idstringRequired

Your identifier for the customer

Max length41Examplecust-b98d6f63-d240-44ec-9bd5-aa42954c4f48

Body parameters<select class='api-response-data' aria-label='Media type'><option value='eaa75587-956b-4d8a-8afe-d6317b0a075a'>application/json</option>
...
<select class='api-response-data' aria-label='Media type'><option value='01679c97-edf2-4808-831c-fa48dc2ce1e2'>application/json</option>
</select><select class='select-example' aria-label='Media type'><option value='dec9121f-8ac4-46d3-a900-9c41f35c6d1f'>getIndividualCustomer</option>
<option value='dad47fab-910b-4e25-944a-cd220d1fed36'>getBusinessCustomer</option>
...
<select class='api-response-data' aria-label='Media type'><option value='5815ace8-03e3-4ba6-b57e-bc5a327fa0a1'>application/json</option>

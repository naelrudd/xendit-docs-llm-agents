...
````json POST /v3/payments/{payment_id}/capture
{
  "openapi": "3.0.0",
  "info": {
    "title": "Payments",
  ...
  "paths": {
    "/v3/payments/{payment_id}/capture": {
      "post": {
        ...
        "description": "Capture authorized payment. Completes payment collection.\n",
        "tags": [
          "Payment"
        ],
        "parameters": [
              ...
              "application/json": {
                "schema": {
                  "oneOf": [
                    ...
                    {
                      "$ref": "#/components/schemas/Payments_API_Http400CaptureAmountExceeded"
                    },
                    {
  ...
  "components": {
    ...
    "schemas": {
      ...
      "Payments_API_Http400CaptureAmountExceeded": {
        "type": "object",
        "required": [
          "error_code",
          "message"
        ...
        "properties": {
          ...
          "message": {
            "type": "string",
            "description": "Capture amount specified in capture request must be less than or equal to uncaptured authorization amount."
          }
        }
      },

...
````json POST /recurring/plans/{plan_id}/cycles/{id}/cancel
{
  "openapi": "3.0.0",
  "info": {
    "title": "Payments",
  ...
  "paths": {
    "/recurring/plans/{plan_id}/cycles/{id}/cancel": {
      "post": {
        ...
        "summary": "Cancel Subscription Cycle",
        "description": "Cancel a cycle plan. Once the cycle is canceled, it will not deduct the end user's balance on the scheduled cycle date.",
        "operationId": "cancelRecurringCycle",
        "parameters": [
          {
            "name": "api-version",
            "in": "header",
        ...
        "responses": {
          "200": {
            "description": "Successfully cancel the recurring cycle.",
            "content": {
              "application/json": {
                "schema": {
          ...
          "403": {
            "description": "Ineligible request",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",

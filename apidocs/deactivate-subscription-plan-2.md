...
````json POST /recurring/plans/{id}/deactivate
{
  "openapi": "3.0.0",
  "info": {
    "title": "Payments",
  ...
  "paths": {
    "/recurring/plans/{id}/deactivate": {
      "post": {
        ...
        "description": "Deactivates a subscription plan, stopping all subsequent cycles and marking the plan as inactive.",
        "operationId": "deactivateRecurringPlan",
        "parameters": [
          {
            "name": "api-version",
            "in": "header",
        ...
        "responses": {
          "200": {
            "description": "Successfully deactivate a recurring plan.",
            "content": {
              "application/json": {
                "schema": {

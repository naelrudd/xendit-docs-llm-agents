...
````json POST /v3/payments/{payment_id}/cancel
{
  "openapi": "3.0.0",
  "info": {
    "title": "Payments",
  ...
  "paths": {
    "/v3/payments/{payment_id}/cancel": {
      "post": {
        ...
        "description": "Cancel a payment. Only applicable for payments in `AUTHORIZED` status.\n",
        "tags": [
          "Payment"
        ],
        "parameters": [
        ...
        "responses": {
          "200": {
            "description": "Cancel Payment Status",
            "content": {
              "application/json": {
                "schema": {

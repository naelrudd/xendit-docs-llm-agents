...
````json POST /recurring/plans/{plan_id}/cycles/{id}/force_attempt
{
  "openapi": "3.0.0",
  "info": {
    "title": "Payments",
  ...
  "paths": {
    "/recurring/plans/{plan_id}/cycles/{id}/force_attempt": {
      "post": {
        ...
        "summary": "Force Attempt Subscription Cycle",
        "description": "manually force an attempt for the specified action of a subscription cycle before the initial scheduled date.",
        "operationId": "forceAttemptRecurringCycle",
        "parameters": [
          {
            "name": "api-version",
            "in": "header",
          ...
          },
          {
            ...
            "in": "path",
            "required": "true",
            "description": "The ID of the recurring plan associated with the cycle.",
            "schema": {
              "type": "string"
            }
          },
        ...
        "responses": {
          ...
          "403": {
            "description": "Ineligible request. Safe to retry.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
                ...
                "examples": {
                  "INELIGIBLE_CYCLE_REQUEST": {
                    "summary": "Request cannot be processed.",
                    "value": {
